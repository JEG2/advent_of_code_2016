defmodule Arrangement do
  ...
  def new(floors) do
    new_floors = Keyword.update!(floors, :f1, fn floor ->
      Enum.sort(floor ++ ~w[EG EM DG DM])
    end)
    struct(__MODULE__, new_floors)
  end
...
defmodule AssemblerWithExtras do
